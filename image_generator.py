...
BOTH_THEMES = [
    ...
    {"file": "both1.png",
     "greet_x": 0.67, "greet_y": 0.24, "greet_color": (255, 215, 0),  "greet_size": 60,
     "name_x": 0.65, "name_y":  0.33, "name_color":  (255, 215, 0), "name_size":  70,
    ...
    {"file": "both2.png",
     "greet_y": 0.35, "greet_color": (255, 255, 255), "greet_size": 60,
     "name_y":  0.45, "name_color":  (212, 175, 55),  "name_size":  78,
     "hol_y":   0.57, "hol_color":   (212, 175, 55),  "hol_size":   55,
     "sub_y":   0.66, "sub_color":   (200, 220, 255),  "sub_size":   45,
     "shadow": (5, 15, 40)},

    # both3 — oltin fon, qora ramka ichida bo'sh
    {"file": "both3.png",
     "greet_y": 0.30, "greet_color": (212, 175, 55),  "greet_size": 60,
     "name_y":  0.40, "name_color":  (212, 175, 55),  "name_size":  82,
     "hol_y":   0.52, "hol_color":   (212, 175, 55),   "hol_size":   55,
     "sub_y":   0.62, "sub_color":   (212, 175, 55),   "sub_size":   45,
     "shadow": (10, 5, 0)},
    ...
    {"file": "both5.png",
     "greet_y": 0.37, "greet_color": (212, 175, 55),  "greet_size": 58,
    ...
    {"file": "both6.png",
     "greet_y": 0.28, "greet_color": (150, 100, 20),  "greet_size": 60,
     "name_y":  0.38, "name_color":  (100, 60, 10),   "name_size":  80,
     "hol_y":   0.50, "hol_color":   (150, 100, 20),  "hol_size":   55,
     "sub_y":   0.60, "sub_color":   (150, 100, 20),  "sub_size":   45,
     "shadow": (200, 180, 150)},
    ...
    {"file": "both8.png",
     "greet_y": 0.30, "greet_color": (212, 175, 55),  "greet_size": 60,
     "name_y":  0.40, "name_color":  (255, 215, 0),   "name_size":  80,
     "hol_y":   0.50, "hol_color":   (212, 175, 55),  "hol_size":   55,
     "sub_y":   0.60, "sub_color":   (212, 175, 55),  "sub_size":   45,
     "shadow": (30, 5, 40)},

    # both9 — ko'k yulduz shakli, markazda bo'sh
    {"file": "both9.png",
     "greet_y": 0.32, "greet_color": (212, 175, 55),  "greet_size": 60,
     "name_y":  0.42, "name_color":  (255, 215, 0),   "name_size":  80,
     "hol_y":   0.54, "hol_color":   (212, 175, 55),  "hol_size":   55,
     "sub_y":   0.63, "sub_color":   (212, 175, 55),  "sub_size":   45,
     "shadow": (5, 20, 40)},
...
QURBON_THEMES = [
    ...
    "greet_x": 0.70, "greet_y": 0.22,  "greet_color": (100, 60, 10),  "greet_size": 60,
    "name_x":  0.70, "name_y":  0.32,  "name_color":  (80,  50, 10),  "name_size":  72,
    ...
    {"file": "qurbonhayiti3.png",
     "greet_x": 0.70, "greet_y": 0.25, "greet_color": (100, 60, 10),   "greet_size": 60,
     "name_x":  0.70, "name_y":  0.35, "name_color":  (80,  50,  10),  "name_size":  72,
     "hol_x":   0.70, "hol_y":   0.47, "hol_color":   (100, 60, 10),   "hol_size":   55,
     "sub_x":   0.70, "sub_y":   0.57, "sub_color":   (100, 60, 10),   "sub_size":   45,
     "shadow": (200, 180, 150),
     "x_offset": 280},

    # qurbon4 — oq fon, o'ng tomonda bo'sh
    {"file": "qurbonhayiti4.jpeg",
     "greet_x": 0.70, "greet_y": 0.25, "greet_color": (80,  50,  80),  "greet_size": 60,
...
RAMAZON_THEMES = [
    ...
    {"file": "ramazonhayiti1.jpeg",
     "greet_x": 0.73, "greet_y": 0.30, "greet_color": (212, 175, 55),  "greet_size": 60,
     "name_x":  0.77, "name_y":  0.41, "name_color":  (255, 215, 0),   "name_size":  72,
     "hol_x":   0.77, "hol_y":   0.51, "hol_color":   (212, 175, 55),  "hol_size":   55,
     "sub_x":   0.77, "sub_y":   0.61, "sub_color":   (212, 175, 55),  "sub_size":   45,
     "shadow": (5, 15, 40),
     "x_offset": 280},

    # ramazon2 — chiroq rasm, yuqori qism bo'sh
    {"file": "ramazonhayiti2.jpeg",
     "greet_x": 0.30, "greet_y": 0.35, "greet_color": (212, 175, 55),  "greet_size": 60,
     "name_x":  0.30, "name_y":  0.50, "name_color":  (255, 215, 0),   "name_size":  72,
     "hol_x":   0.30, "hol_y":   0.65, "hol_color":   (212, 175, 55),  "hol_size":   55,
     "sub_x":   0.30, "sub_y":   0.80, "sub_color":   (212, 175, 55),  "sub_size":   45,
     "shadow": (5, 10, 30)},

    # ramazon3 — ko'k oy masjid, pastki qism bo'sh
    {"file": "ramazonhayiti3.jpeg",
     "greet_x": 0.30, "greet_y": 0.07, "greet_color": (200, 230, 255), "greet_size": 60,
     "name_x":  0.30, "name_y":  0.15, "name_color":  (200, 230, 255),  "name_size":  72,
     "hol_x":   0.80, "hol_y":   0.78, "hol_color":   (200, 230, 255),  "hol_size":   55,
     "sub_x":   0.80, "sub_y":   0.87, "sub_color":   (200, 230, 255),  "sub_size":   45,
     "shadow": (5, 20, 50)},

    # ramazon4 — oltin gumbaz, markazda bo'sh joy
    {"file": "ramazonhayiti4.jpeg",
     "greet_x": 0.72, "greet_y": 0.42, "greet_color": (255, 215, 0),  "greet_size": 60,
     "name_x":  0.73, "name_y":  0.52, "name_color":  (255, 215, 0),   "name_size":  72,
    ...
    {"file": "ramazonhayiti5.jpeg",
     "greet_x": 0.50, "greet_y": 0.10, "greet_color": (255, 215, 0),  "greet_size": 60,
     "name_x":  0.50, "name_y":  0.20, "name_color":  (255, 215, 0),   "name_size":  72,
     "hol_x":   0.50, "hol_y":   0.30, "hol_color":   (255, 215, 0),  "hol_size":   55,
     "sub_x":   0.50, "sub_y":   0.37, "sub_color":   (255, 215, 0),  "sub_size":   45,
     "shadow": (10, 5, 0)},
]
